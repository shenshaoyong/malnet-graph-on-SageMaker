...
def get_split_info(args):
    ...
    split_dir = 'split_info_tiny' if args['malnet_tiny'] else 'split-info'
    data_dir = args['malnet_tiny_dir'] if args['malnet_tiny'] else args['malnet_dir']
    parent_dir = '/opt/ml/input/data/train'

    with open(parent_dir + '/{}/{}/{}/train.txt'.format(split_dir, args['group'], args['train_ratio']), 'r') as f:
        lines_train = f.readlines()

    with open(parent_dir + '/{}/{}/{}/val.txt'.format(split_dir, args['group'], args['train_ratio']), 'r') as f:
        lines_val = f.readlines()

    with open(parent_dir + '/{}/{}/{}/test.txt'.format(split_dir, args['group'], args['train_ratio']), 'r') as f:
